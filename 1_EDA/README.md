...
1. [01_top_demanded_skill.sql](./01_top_demanded.skills.sql) - demand analysis with multi-table joins
2. [02_top_paying_skills.sql](./02_top_paying_skills.sql) - salary analysis with aggregations
3. [03_optimal_skills.sql](./03_optimal_skills.sql) - combined demand/salary optimazation query
...
- **Dimension Tables:**
    - `company dim` - Company information linked to job postings
    - `skills dim` - Skills catalog with skill names and types
- **Bridge Table:** `skills_job_dim` - Resolves the many-to-many relationship between job postings and skills

By querying acros the interconnected tables, I extracted insights about skill demand, salary patterns, and optimal skill combinations for data engineering roles. 
...
### Query Structure
1. **[Top Demanded Skills](./01_top_demanded.skills.sql)** - demand analysis with multi-table joins
2. **[Top Paying Skills](./02_top_paying_skills.sql)** - salary analysis with aggregations
3. **[Optimal Skills](./03_optimal_skills.sql)** - combined demand/salary optimazation query
...
- **Complex Joins:** Multi-table `INNNER JOIN` and `LEFT JOIN` operations across `job_postings_fact`, `skills_job_dim`, and `skills_dim`
- **Sub Queries:** Using subqueries for readability across `job_postings_fact`, `skills_job_dim`, and `skills_dim`
